...
La clase \texttt{Graph} utiliza listas de adyacencia. Un aspecto crítico para la eficiencia del RPM es que las listas de adyacencia se \textbf{pre-ordenan por peso} al inicio del programa.
